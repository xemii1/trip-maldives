# Мальдивы — маршрут поездки, 27 вариантов размещения (реальные цены)
...
**Вывод:** бюджет 500 000 ₽ на двоих за 7 ночей с настоящим «всё включено + алкоголь» на острове-курорте Мальдив в начале ноября 2026 — трудно достижим, но не невозможен: **4 настоящих курортных острова** (Canareef, Adaaran Hudhuranfushi, Ellaidhoo, Cinnamon Dhonveli) укладываются в бюджет с гарантированным алкоголем. Perla Dhangethi формально тоже укладывается по цене, но алкоголь там, вероятнее всего, не входит — сохранён в списке как самый дешёвый бюджетный вариант, но с явной пометкой несоответствия требованию.

Вариантов, уложившихся в бюджет по цене: **5 из 27** проверенных, из них с подтверждённым алкоголем — **4**. Максимум в подборке — 808 590 ₽, минимум — 343 866 ₽. Таблица отсортирована по возрастанию итоговой цены.
